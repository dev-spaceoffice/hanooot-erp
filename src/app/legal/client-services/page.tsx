...
const stats = [{"label": "Billable this month", "value": "USD 74K", "detail": "retainers and matters", "tone": "green"}, {"label": "Needs attention", "value": "6", "detail": "2 overdue", "tone": "red"}, {"label": "Retainers", "value": "12", "detail": "renewal soon", "tone": "amber"}, {"label": "Enquiries", "value": "21", "detail": "incoming client enquiries", "tone": "blue"}] satisfies HanoootStat[]

const columns = [{"title": "Pipeline by service", "cards": [{"title": "Company formation", "meta": "Salameh & Sons", "value": "New", "tone": "blue"}, {"title": "Retainer renewal", "meta": "Mansour Group", "value": "Renew", "tone": "amber"}]}, {"title": "Needs attention", "cards": [{"title": "Import contract clause", "meta": "Owner review required", "value": "Today", "tone": "red"}]}, {"title": "Documents", "cards": [{"title": "Legal document generator", "meta": "NDA template v3.docx · shared platform storage", "value": "Ready", "tone": "green"}]}] satisfies { title: string; cards: HanoootCard[] }[]

const tableColumns = ["Enquiry", "Service", "Source", "Value", "Stage", "Owner"]
const tableRows = [["Salameh & Sons", "Company formation", "Referral", "USD 8K", "New", "Mariam"], ["Mansour Group", "Retainer", "Existing", "USD 24K", "Renewal", "Abdullah Abbas"], ["Obeidat Trading", "Import contract", "Importing", "USD 12K", "Review", "Tania"]]
const chips = ["Client services", "Pipeline", "Needs attention", "Retainers", "Documents"]

const Page = () => (
  <HanoootAppShell active="legal" primaryAction="Create enquiry" title="Legal">
    <div className="mx-auto flex max-w-[1180px] flex-col gap-4" data-hanooot-route="Legal · Client Services">
      <section className="rounded-[22px] border border-[#E4E0D6] bg-white p-5 shadow-[0_8px_24px_rgba(40,36,30,0.06)]">
        <p className="text-[11px] font-semibold uppercase tracking-[0.09em] text-[#78736A]">CLIENT SERVICES</p>
        <h1 className="mt-2 text-[28px] font-semibold leading-tight tracking-[-0.035em] text-[#3C382F]">Legal · Client Services</h1>
        <p className="mt-3 max-w-3xl text-[13px] leading-6 text-[#78736A]">Client-services dashboard, billable month, pipeline by service, needs-attention table, enquiries, retainers and legal documents.</p>
      ...
      <section className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_330px]">
        <div className="space-y-4">
          ...
          <div className="rounded-[22px] border border-[#E4E0D6] bg-white p-4 shadow-[0_8px_24px_rgba(40,36,30,0.06)]">
            <h2 className="mb-4 text-[16px] font-semibold text-[#3C382F]">Enquiry table</h2>
