...
const Page = () => (
  <HanoootAppShell active="hr" primaryAction="Add employee" title="People">
    <div className="mx-auto flex max-w-[1180px] flex-col gap-4" data-hanooot-route="People · Payroll">
      <section className="rounded-[22px] border border-[#E4E0D6] bg-white p-5 shadow-[0_8px_24px_rgba(40,36,30,0.06)]">
        ...
        <h1 className="mt-2 text-[28px] font-semibold leading-tight tracking-[-0.035em] text-[#3C382F]">People · Payroll</h1>
